package com.example.cosmin.androidfundamentals.proiectFinal.login;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_trip_journal);
    ...
    public void onStart() {
        ...
        Log.d(TAG, "oare asta e problema?");


    }

    private void goHomeActivityIfAuthenticated(){
        Log.d(TAG, "navigheaza acasa daca userul e logat");

        if(mAuth.getCurrentUser() != null){
            Intent intent = new Intent(LoginActivity.this, MainTripActivity.class);
